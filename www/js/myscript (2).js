...
function addNewStatus(){
    ...
    if(next_call_date == '' || summary_note == ''){
      ...
      $('.loader').show();
        $.ajax({
            url: "./APIs/api.php",
            data: {operation: "008",leadId:leadId,next_call_date:next_call_date,time:time,summary_note:summary_note},
            success: function (response){
      $('.loader').hide();
                    if(response==1){
...
function allLeadsOnDate(date){
      ...
      $('.loader').hide();
                        ...
                        for (let index = 1; index <= totalUpdates; index++) {
                            ...
                            var part = element.split("<-->");
                            if(part[8]=="New"){
                            content+= '<tr><th scope="row">'+part[0]+'</th><td>'+part[1]+'</td><td>'+part[2]+'<br>'+part[3]+'<br>'+part[4]+'<br>'+part[5]+'</td><td>'+part[6]+'</td><td>'+part[7]+'</td><td style="background-color:red;color:white">'+part[8]+'</td><td>'+part[9]+'</td><td><button data-toggle="modal" data-target="#exampleModal3" onclick="fillUpdateForm('+part[0]+')">Edit</button><br><button data-toggle="modal" data-target="#exampleModal4" data-whatever="'+part[0]+'" onclick="getAllStatus('+part[0]+')">Status</button></td><td>'+part[10]+'</td></tr>';
                            }else if(part[8]=="Converted"){
                            content+= '<tr><th scope="row">'+part[0]+'</th><td>'+part[1]+'</td><td>'+part[2]+'<br>'+part[3]+'<br>'+part[4]+'<br>'+part[5]+'</td><td>'+part[6]+'</td><td>'+part[7]+'</td><td style="background-color:green;color:white">'+part[8]+'</td><td>'+part[9]+'</td><td><button data-toggle="modal" data-target="#exampleModal3" onclick="fillUpdateForm('+part[0]+')">Edit</button><br><button data-toggle="modal" data-target="#exampleModal4" data-whatever="'+part[0]+'" onclick="getAllStatus('+part[0]+')">Status</button></td><td>'+part[10]+'</td></tr>';
                            }else if(part[8]=="Proposail Mailed"){
                            content+= '<tr><th scope="row">'+part[0]+'</th><td>'+part[1]+'</td><td>'+part[2]+'<br>'+part[3]+'<br>'+part[4]+'<br>'+part[5]+'</td><td>'+part[6]+'</td><td>'+part[7]+'</td><td style="background-color:yellow;color:black">'+part[8]+'</td><td>'+part[9]+'</td><td><button data-toggle="modal" data-target="#exampleModal3" onclick="fillUpdateForm('+part[0]+')">Edit</button><br><button data-toggle="modal" data-target="#exampleModal4" data-whatever="'+part[0]+'" onclick="getAllStatus('+part[0]+')">Status</button></td><td>'+part[10]+'</td></tr>';
                            ...
                            content+= '<tr><th scope="row">'+part[0]+'</th><td>'+part[1]+'</td><td>'+part[2]+'<br>'+part[3]+'<br>'+part[4]+'<br>'+part[5]+'</td><td>'+part[6]+'</td><td>'+part[7]+'</td><td>'+part[8]+'</td><td>'+part[9]+'</td><td><button data-toggle="modal" data-target="#exampleModal3" onclick="fillUpdateForm('+part[0]+')">Edit</button><br><button data-toggle="modal" data-target="#exampleModal4" data-whatever="'+part[0]+'" onclick="getAllStatus('+part[0]+')">Status</button></td><td>'+part[10]+'</td></tr>';
                            }
...
function checkDiscountPayment(id){
    ...
    $.ajax({
      ...
      $('.loader').hide();
          if(response!=0){
              document.getElementById("dicountDiv").style.display = "none";
              document.getElementById("ifDiscountAdded").innerHTML = "<h4>Discount of Rs. "+response+"/- applied</h4><br><button class='btn btn-secondary' onclick='removeDiscount("+id+")'>Remove Discount</button>";
          }else{
...
function addProjectDiscount(){
    ...
    var discount = document.getElementById("discountAmount").value;
      ...
      $('.loader').show();
          $.ajax({
              url: "./APIs/api.php",
              data: {operation:"036",id:id,discount:discount},
              success: function(response){
      $('.loader').hide();
                  if(response == 1){
...
function addProjectPayment(){
    ...
    alert(updateBy);
      ...
      $('.loader').show();
          $.ajax({
              url: "./APIs/api.php",                      //Server api to receive the file
                     type: "POST",
                     dataType: 'script',
                     cache: false,
                     contentType: false,
...
function rawDataforCaller(){
    rawData();
 /*   var content = "<div class='container'><center><h1>Raw Data</h1></center><table id='rawDataTable' class='table table-striped table-bordered'><thead><th>ID</th><th>Name</th><th>Mobile</th><th>DOR</th></thead><tbody>";
      $('.loader').show();
     $.ajax({
                    type: "POST",
                    url: "https://softwarezsolution.com/app/SampleEComApp/admin/api/forcrm.php",
                    ...
                    $('.loader').hide();
                        ...
                        for(let i = 0;i<element.length;i++){
                            var data = element[i];
                            content += "<tr><td>"+data[0]+"</td><td>"+data[1]+"</td><td>"+data[2]+"</td><td>"+data[5]+"</td></tr>"
                        }
     ...
     console.log(response);
      var partialArranged = response.split("<END>");
            ...
            for (let index = 1; index <= totalUpdates; index++) {
                ...
                // content+= '<tr><th scope="row">'+part[0]+'</th><td>'+part[1]+'</td><td>'+part[2]+'<br>'+part[3]+'<br>'+part[4]+'<br>'+part[5]+'</td><td>'+part[11]+'<br>'+part[12]+'</td><td>'+part[6]+'</td><td>'+part[7]+'</td><td>'+part[8]+'</td><td>'+part[9]+'</td><td><button data-toggle="modal" data-target="#exampleModal3" onclick="fillUpdateForm('+part[0]+')">Edit</button><br><button data-toggle="modal" data-target="#exampleModal4" data-whatever="'+part[0]+'" onclick="getAllStatus('+part[0]+')">Status</button></td><td>'+part[10]+'</td></tr>';
                // }else{
                    content+= '<tr><th scope="row">'+part[0]+'</th><td>'+part[1]+'</td><td>'+part[2]+'<br>'+part[3]+'<br>'+part[4]+'<br>'+part[5]+'</td><td>'+part[11]+'<br>'+part[12]+'</td><td>'+part[6]+'</td><td>'+part[7]+'</td><td>'+part[8]+'</td><td>'+part[9]+'</td><td><button data-toggle="modal" data-target="#exampleModal5" data-whatever="'+part[0]+'" onclick="getAllStatus('+part[0]+')">Status</button></td><td>'+part[10]+'</td></tr>';
                // }
            }
            content += '</tbody></table></div>';
    ...
    $.ajax({
      ...
      $('.loader').hide();
            if(response == 0){
                ...
                var message = "Hi "+data[1]+",<br><b>Customer ID: "+data[3]+"</b><br><br>Your Project <b>"+data[2]+"</b> with Project ID: "+data[4]+" Dated: "+data[5]+" is up for Renewal. Please pay the remaining dues on or before the expiry date to continue uninterrupted service.<br><b>Expiry Date :"+expiry+"</b><br><br>Regards<br>"+data[6]+"<br>"+data[7]+"<br><b>Kalam Academy</b>";
    ...
    var statsFor = document.getElementById("statsFor").value;
     ...
     $('.loader').hide();
            if(response == "dateError"){
                ...
                document.getElementById("displayContent").innerHTML = "<h1>STATISTICS</h1><div class='row'><div class='col-6'><h4>Start Date: "+startDate+"</h4></div><div class='col-6'><h4>End Date: "+endDate+"</h4></div></div><hr><div class='row'><div class='col-4'><h3 style='color:red;' >Billing Amount : "+billing+"</h3></div><div class='col-4'><h3 style='color:green;'>Payment Recieved : "+payment+"</h3></div><div class='col-4'><h3 style='color:red;'>Dues : "+(billing - payment)+"</h3></div></div><hr><div class='mt-5 row'><div class='col-lg-6'><div id='statsDisplayGraph1'></div><div id='statsDisplay1'></div></div><div class='col-lg-6'><h1>TEAM STATISTICS</h1><div id='statsDisplayGraph2'></div><div id='statsDisplay2' class='mt-5'></div></div></div>";
...
function getBusinessStats(startDate,endDate,statsFor){
     ...
     $('.loader').hide();
            if(response == "dateError"){
                ...
                var content = "<h1>BUSINESS STATISTICS</h1><table id='statsTable1' class='table table-striped table-bordered'><thead><th>Project ID</th><th>User's Name</th><th>Billing</th><th>Payment</th><th>Dues</th></thead><tbody>"
                ...
                for(let i=0;i<length;i++){
                    ...
                    content += "<tr><td>"+data[1]+"</td><td>"+data[0]+"</td><td>"+data[2]+"</td><td>"+data[3]+"</td><td>"+data[4]+"</td></tr>"
...
function getConvertedStats(startDate,endDate,statsFor){
     ...
     $('.loader').hide();
            if(response == "dateError"){
                ...
                var content = "<table id='statsTable2' class='table table-striped table-bordered'><thead><th>Name</th><th>Converted</th><th>Calls Made</th></thead><tbody>"
                var element = response.split("/END/");
                var length = element.length -1;
                 var s1=[],s2=[],ticks=[];
                for(let i=0;i<length;i++){
                    ...
                    ticks[i] = data[1];
                    content += "<tr><td>"+data[1]+"</td><td>"+data[2]+"</td><td>"+data[3]+"</td></tr>";
        ...
        success: function(response){
            ...
            for (let index = 1; index <= totalUpdates; index++) {
                ...
                if(part[9] != ''){
                    ...
                    if(!condition)status = "Delayed Not Completed";
                    special = "<button onclick='markCompletion2("+part[13]+")'>Mark Complete</button>";
                }
