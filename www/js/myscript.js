...
function fetchData() {
  ...
  Promise.all([
    ...
    .then(
      ([todayData, yesterdayData, thirtyDaysBackData, sixtyDaysBackData]) => {
...
function filterAndCalculateData(rawData, breakTime, leadCount) {
  ...
  rawData.forEach((call) => {
    ...
    if (
      (call.Summary_Note &&
        call.Summary_Note.toLowerCase().includes("demo done")) ||
  ...
  const leadToDemo =
    !leadCount || !demoCount ? 0 : Math.round(leadCount / demoCount);
...
function compareAndPopulateData(
  ...
  const elements = [
    {
      id: "#tot-dial .today",
      todayValue: todayData.callToday,
      yesterdayValue: yesterdayData.callToday,
    },
    {
      id: "#totalLeads .today",
      todayValue: todayData.leadCount,
      yesterdayValue: yesterdayData.leadCount,
    },
    {
      id: "#demoRatio .today",
      todayValue: todayData.leadToDemo,
      yesterdayValue: yesterdayData.leadToDemo,
    },
    {
      id: "#tot-concted .today",
      todayValue: todayData.countConnected,
      yesterdayValue: yesterdayData.countConnected,
    },
    {
      id: "#tot-not-concted .today",
      todayValue: todayData.countNotConnected,
      yesterdayValue: yesterdayData.countNotConnected,
      reverseColor: true,
    },
    {
      id: "#call-durt .today",
      todayValue: todayData.totalCallDuration,
      yesterdayValue: yesterdayData.totalCallDuration,
      isTime: true,
    },
    {
      id: "#demo .today",
      todayValue: todayData.demoCount,
      yesterdayValue: yesterdayData.demoCount,
    },
    {
      id: "#follow .today",
      todayValue: todayData.followup,
      yesterdayValue: yesterdayData.followup,
      reverseColor: true,
    },
    {
      id: "#monster .today",
      todayValue: todayData.monster,
      yesterdayValue: yesterdayData.monster,
      reverseColor: true,
    },
    {
      id: "#nrced .today",
      todayValue: todayData.notrecoded,
      yesterdayValue: yesterdayData.notrecoded,
      reverseColor: true,
    },
    {
      id: "#brk-time .today",
      todayValue: todayData.breakTime,
      yesterdayValue: yesterdayData.breakTime,
      isTime: true,
      reverseColor: true,
    },
  ];
  ...
  elements.forEach((item) => {
    const todayValue = item.isTime
      ? secondsToTime(item.todayValue)
      : item.todayValue;
    const yesterdayValue = item.isTime
      ? secondsToTime(item.yesterdayValue)
      : item.yesterdayValue;
    ...
    if (diffTodayYesterday > 0) {
      arrowTodayYesterday = `<i class="fa fa-arrow-up text-${
        isReverse ? "danger" : "success"
      }"></i>`;
      diffTextTodayYesterday = `(+${
        item.isTime ? secondsToTime(diffTodayYesterday) : diffTodayYesterday
      })`;
    } else if (diffTodayYesterday < 0) {
      arrowTodayYesterday = `<i class="fa fa-arrow-down text-${
        isReverse ? "success" : "danger"
      }"></i>`;
      diffTextTodayYesterday = `(${
        item.isTime ? secondsToTime(diffTodayYesterday) : diffTodayYesterday
      })`;
  ...
  const elements30Days = [
    {
      id: "#tot-dial .month",
      thirtyValue: thirtyDaysBackData.callToday,
      sixtyValue: sixtyDaysBackData.callToday,
    },
    {
      id: "#totalLeads .month",
      thirtyValue: thirtyDaysBackData.leadCount,
      sixtyValue: sixtyDaysBackData.leadCount,
    },
    {
      id: "#demoRatio .month",
      thirtyValue: thirtyDaysBackData.leadToDemo,
      sixtyValue: sixtyDaysBackData.leadToDemo,
    },
    {
      id: "#tot-concted .month",
      thirtyValue: thirtyDaysBackData.countConnected,
      sixtyValue: sixtyDaysBackData.countConnected,
    },
    {
      id: "#tot-not-concted .month",
      thirtyValue: thirtyDaysBackData.countNotConnected,
      sixtyValue: sixtyDaysBackData.countNotConnected,
      reverseColor: true,
    },
    {
      id: "#call-durt .month",
      thirtyValue: thirtyDaysBackData.totalCallDuration,
      sixtyValue: sixtyDaysBackData.totalCallDuration,
      isTime: true,
    },
    {
      id: "#demo .month",
      thirtyValue: thirtyDaysBackData.demoCount,
      sixtyValue: sixtyDaysBackData.demoCount,
    },
    {
      id: "#follow .month",
      thirtyValue: thirtyDaysBackData.followup,
      sixtyValue: sixtyDaysBackData.followup,
      reverseColor: true,
    },
    {
      id: "#monster .month",
      thirtyValue: thirtyDaysBackData.monster,
      sixtyValue: sixtyDaysBackData.monster,
      reverseColor: true,
    },
    {
      id: "#nrced .month",
      thirtyValue: thirtyDaysBackData.notrecoded,
      sixtyValue: sixtyDaysBackData.notrecoded,
      reverseColor: true,
    },
    {
      id: "#brk-time .month",
      thirtyValue: thirtyDaysBackData.breakTime,
      sixtyValue: sixtyDaysBackData.breakTime,
      isTime: true,
      reverseColor: true,
    },
  ];
  ...
  elements30Days.forEach((item) => {
    const thirtyValue = item.isTime
      ? secondsToTime(item.thirtyValue)
      : item.thirtyValue;
    const sixtyValue = item.isTime
      ? secondsToTime(item.sixtyValue)
      : item.sixtyValue;
    ...
    if (diff30vs30 > 0) {
      arrow30vs30 = `<i class="fa fa-arrow-up text-${
        isReverse ? "danger" : "success"
      }"></i>`;
      diffText30vs30 = `(+${
        item.isTime ? secondsToTime(diff30vs30) : diff30vs30
      })`;
    } else if (diff30vs30 < 0) {
      arrow30vs30 = `<i class="fa fa-arrow-down text-${
        isReverse ? "success" : "danger"
      }"></i>`;
      diffText30vs30 = `(${
        item.isTime ? secondsToTime(diff30vs30) : diff30vs30
...
function changeModalName(name) {
  if (name == "Add") {
    ...
    document.getElementById(
      "resuableModalFooter"
    ).innerHTML = ` <button type="button" class="btn btn-secondary close" data-dismiss="modal">Close</button>
...
async function getSupportStats() {
  ...
  try {
    ...
    document.getElementById("delayed-task").textContent =
      stats.total_delayed_tasks;
    document.getElementById("delayed-not-completed").textContent =
      stats.total_delayed_not_completed;
    document.getElementById(
      "completed-before-time"
    ).textContent = `${stats.total_completed_on_time}/${stats.total_completed_before_time}`;
    document.getElementById(
      "fake-task"
    ).textContent = `${stats.total_fake_completion_tasks}/${stats.total_incomplete_task_tasks}`;
  } catch (error) {
    displayerror(error);
  }
}
...
async function uploadImage() {
  ...
  try {
    ...
    if (responseData.success === true) {
      ...
      $("#fileurl").val(
        (i, val) => val.trim() + (val.trim() ? " " : "") + responseData.imageUrl
      );
...
async function showTeam() {
  ...
  document.getElementById("displayContent").innerHTML =
    "<h1>MY Team </h1><div style='overflow-x:scroll;'>" + content;
...
async function getTrancations(type) {
  ...
  try {
    ...
    document.getElementById("tablereporttrans").innerHTML =
      content + "</tbody></table>";
    ...
    try {
      const promises = endpoints.map((endpoint) =>
        fetch(Config.api_url, {
          ...
          if (!res.ok) {
            throw new Error(
              `Failed to fetch ${endpoint.operation}: ${res.statusText}`
            );
          }
          return res.json();
        })
      ...
      console.error(
        `Error fetching reports for range ${start} - ${end}:`,
        error
      );
      ...
      try {
        ...
        cordova.plugins.callLog.list(
          ...
          async function (response) {
            try {
              const missedCalls = response.rows.filter(
                (call) => call.type == 3
              );
              ...
              if (!apiResponse.ok) {
                throw new Error(
                  `Error submitting missed calls: ${apiResponse.statusText}`
                );
              }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  $("#sidebarCollapse").after(
    '<a id="admin-name" onclick="redirectcal()" style="color:white">Hi, ' +
      localStorage.getItem("userName") +
      " <br>(Your Attendence)</a>"
  );
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          data.members.forEach(function (option) {
            ...
            if (data.selected) {
              isSelected = data.selected.some(
                (selectedMember) =>
                  selectedMember.Admin_ID.trim() === option.Admin_ID.trim()
              );
            }
...
function selectLead(lead, filename) {
  ...
  document.getElementById(
    "searchInput"
  ).value = `${lead.leadName} - ${lead.phone}`;
  document.getElementById("searchResults").innerHTML = "";
  document.getElementById("searchResults").style.display = "none";

  const selectButtonContainer = document.getElementById(
...
function generateCombinedTable(start, end, dataMain1, dataMain2) {
  ...
  const noDuesMyGalla = parseSafe(
    dataMain1.data3.noDuesLeadCounts.noDues_mygalla
  );
  ...
  const totalExpenseMyGalla = parseSafe(
    dataMain1.data1.totals.total_expense_mygalla
  );
  const totalExpenseDM = parseSafe(dataMain1.data1.totals.total_expense_DM);
  const totalExpenseOther = parseSafe(
    dataMain1.data1.totals.total_expense_other
  );
  ...
  const avgDaysDifferenceMyGalla = parseSafe(
    dataMain1.data4.averageDaysDifference.mygalla
  );

  const leadCountDM = parseSafe(dataMain1.data4.leadCounts.dm_dmcourse_wdc);
  const avgDaysDifferenceDM = parseSafe(
    dataMain1.data4.averageDaysDifference.dm_dmcourse_wdc
  );

  const leadCountOther = parseSafe(dataMain1.data4.leadCounts.other);
  const avgDaysDifferenceOther = parseSafe(
    dataMain1.data4.averageDaysDifference.other
  );

  // Calculate percentage values and financials safely
  const percentageNoDuesMyGalla =
    leadMyGalla > 0 ? Math.round((noDuesMyGalla / leadMyGalla) * 100) : 0;
  const percentageNoDuesDM =
    leadDM > 0 ? Math.round((noDuesDM / leadDM) * 100) : 0;
  const percentageNoDuesOther =
    leadOther > 0 ? Math.round((noDuesOther / leadOther) * 100) : 0;

  const profitMyGalla = totalPaymentAmount1 - totalExpenseMyGalla;
  const refProfitMyGalla =
    dataMain2.data3.totalPaymentAmount1 -
    dataMain2.data1.totals.total_expense_mygalla;
  ...
  const refProfitDM =
    dataMain2.data3.totalPaymentAmount2 -
    dataMain2.data1.totals.total_expense_DM;
  ...
  const refProfitOther =
    dataMain2.data3.totalPaymentAmount3 -
    dataMain2.data1.totals.total_expense_other;
  ...
  const refcplMygalla = Math.round(
    dataMain2.data1.totals.spend_mygalla / dataMain2.data1.totals.lead_mygalla
  );
  const refcplDM = Math.round(
    dataMain2.data1.totals.spend_DM / dataMain2.data1.totals.lead_DM
  );
  const refcplOther = Math.round(
    dataMain2.data1.totals.spend_other / dataMain2.data1.totals.lead_other
  );
  ...
  const refcacMygalla = Math.round(
    dataMain2.data1.totals.spend_mygalla /
      dataMain2.data3.noDuesLeadCounts.noDues_mygalla
  );
  const refcacDM = Math.round(
    dataMain2.data1.totals.spend_DM / dataMain2.data3.noDuesLeadCounts.noDues_dm
  );
  const refcacOther = Math.round(
    dataMain2.data1.totals.spend_other /
      dataMain2.data3.noDuesLeadCounts.noDues_other
  );
  ...
  const refcammMygalla = Math.round(
    dataMain2.data1.totals.total_expense_mygalla /
      dataMain2.data3.noDuesLeadCounts.noDues_mygalla
  );
  const refcammDM = Math.round(
    dataMain2.data1.totals.total_expense_DM /
      dataMain2.data3.noDuesLeadCounts.noDues_dm
  );
  const refcammOther = Math.round(
    dataMain2.data1.totals.total_expense_other /
      dataMain2.data3.noDuesLeadCounts.noDues_other
  );

  const cpsMygalla = Math.round(
    totalPaymentAmount1 / dataMain1.data3.calls.totalcallinMyGalla
  );
  const cpsDM = Math.round(
    totalPaymentAmount2 / dataMain1.data3.calls.totalcallinDM
  );
  const cpsOther = Math.round(
    totalPaymentAmount3 / dataMain1.data3.calls.totalcallinOthers
  );

  const refcpsMygalla = Math.round(
    dataMain2.data3.totalPaymentAmount1 /
      dataMain2.data3.calls.totalcallinMyGalla
  );
  const refcpsDM = Math.round(
    dataMain2.data3.totalPaymentAmount2 / dataMain2.data3.calls.totalcallinDM
  );
  const refcpsOther = Math.round(
    dataMain2.data3.totalPaymentAmount3 /
      dataMain2.data3.calls.totalcallinOthers
  );
  ...
  var content = `
    ...
    1
                ...
                <td>${cpsMygalla} ${getComparisonArrow(
    cpsMygalla,
    refcpsMygalla,
    1
  )}</td>
                <td>${parseSafe(
                  dataMain1.data2.leadCounts.unassigned_mygalla
                )} ${getComparisonArrow(
    ...
    1
                ...
                <td>${parseSafe(
                  dataMain1.data2.demoCounts.demo_mygalla
                )} ${getComparisonArrow(
    parseSafe(dataMain1.data2.demoCounts.demo_mygalla),
    parseSafe(dataMain2.data2.demoCounts.demo_mygalla),
    2
  )}</td>
                <td>${noDuesMyGalla}/${percentageNoDuesMyGalla}% ${getComparisonArrow(
    noDuesMyGalla,
    dataMain2.data3.noDuesLeadCounts.noDues_mygalla,
    2
  )}</td>
                <td>₹${spendMyGalla} / ${noDuesMyGalla} = ₹${cacMygalla} ${getComparisonArrow(
    cacMygalla,
    refcacMygalla,
    2
  )}</td>
                <td>₹${totalExpenseMyGalla} / ${noDuesMyGalla} = ₹${cacmMygalla} ${getComparisonArrow(
    cacmMygalla,
    refcammMygalla,
    2
  )}</td>
    ...
    1
                ...
                <td>${parseSafe(
                  dataMain1.data2.leadCounts.unassigned_dm
                )} ${getComparisonArrow(
    ...
    1
                ...
                <td>${parseSafe(
                  dataMain1.data2.demoCounts.demo_dm
                )} ${getComparisonArrow(
    parseSafe(dataMain1.data2.demoCounts.demo_dm),
    parseSafe(dataMain2.data2.demoCounts.demo_dm),
    2
  )}</td>
                <td>${noDuesDM}/${percentageNoDuesDM}% ${getComparisonArrow(
    noDuesDM,
    dataMain2.data3.noDuesLeadCounts.noDues_dm,
    2
  )}</td>
                <td>₹${spendDM} / ${noDuesDM} = ₹${cacDM} ${getComparisonArrow(
    cacDM,
    refcacDM,
    2
  )}</td>
                <td>₹${totalExpenseDM} / ${noDuesDM} = ₹${cacmDM} ${getComparisonArrow(
    cacmDM,
    refcammDM,
    2
  )}</td>
    ...
    1
                ...
                <td>${cpsOther} ${getComparisonArrow(
    cpsOther,
    refcpsOther,
    1
  )}</td>
                <td>${parseSafe(
                  dataMain1.data2.leadCounts.unassigned_other
                )} ${getComparisonArrow(
    ...
    1
                ...
                <td>${parseSafe(
                  dataMain1.data2.demoCounts.demo_other
                )} ${getComparisonArrow(
    parseSafe(dataMain1.data2.demoCounts.demo_other),
    parseSafe(dataMain2.data2.demoCounts.demo_other),
    2
  )}</td>
                <td>${noDuesOther}/${percentageNoDuesOther}% ${getComparisonArrow(
    noDuesOther,
    dataMain2.data3.noDuesLeadCounts.noDues_other,
    2
  )}</td>
                <td>₹${spendOther} / ${noDuesOther} = ₹${cacOther} ${getComparisonArrow(
    cacOther,
    refcacOther,
    2
  )}</td>
                <td>₹${totalExpenseOther} / ${noDuesOther} = ₹${cacmOther} ${getComparisonArrow(
    cacmOther,
    refcammOther,
    2
  )}</td>
    ...
    2
                ...
                <td>₹${profitMyGalla} ${getComparisonArrow(
    profitMyGalla,
    refProfitMyGalla,
    2
  )}</td>
                <td>₹${patMyGalla} ${getComparisonArrow(
    patMyGalla,
    refPatMyGalla,
    2
  )}</td>
    ...
    2
                ...
                <td>₹${profitDM} ${getComparisonArrow(
    profitDM,
    refProfitDM,
    2
  )}</td>
    ...
    2
                ...
                <td>₹${profitOther} ${getComparisonArrow(
    profitOther,
    refProfitOther,
    2
  )}</td>
                <td>₹${patOther} ${getComparisonArrow(
    patOther,
    refPatOther,
    2
  )}</td>
...
`;
  ...
  document.getElementById("displayContent").innerHTML =
    "<h1>Expense Report</h1><div style='overflow-x:scroll;'>" +
    content +
    "</div>";
}
...
function expenseReportTable() {
  ...
  document.getElementById("displayContent").innerHTML =
    "<h1>Expense Report </h1><div style='overflow-x:scroll;'>" + content;
}
...
async function handleFileSelecthr(event) {
  ...
  if (selectedFile && acceptedImageTypes.includes(selectedFile.type)) {
    ...
    reader.onload = function (e) {
      ...
      document.getElementById("confirmUploadBtn").style.display =
        "inline-block";
...
function getDevices() {
  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      document.getElementById("displayContent").innerHTML =
        "<h1>Allowed Devices</h1><div class='container mt-5' style='overflow-x:scroll;'>" +
        addDevice +
        the_table +
        "</tbody></div>";
...
function selectDevice(deviceid) {
  ...
  document.getElementById("exampleModalDeviceLabel").innerHTML =
    "Update Device";
  document.getElementById("exampleModalDevicebutton").innerHTML =
    "Update Device";
  $(".loader").show();
  $.ajax({
    url: Config.api_url,
...
function addLead() {
  ...
  if (name == "" || mobile == "") {
    ...
    document.getElementById("errorDetails").innerHTML =
      "Mobile should be 10 digits whithout +91 or 0";
  } else if (alternate_mobile !== "" && !/^\d{1,10}$/.test(alternate_mobile)) {
    document.getElementById("errorDetails").innerHTML =
      "Alternate Mobile should be 10 digits whithout +91 or 0";
  } else if (whatsapp !== "" && !/^\d{1,10}$/.test(whatsapp)) {
    document.getElementById("errorDetails").innerHTML =
      "WhatsApp should be 10 digits whithout +91 or 0";
  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      document.getElementById("displayContent").innerHTML =
        "<h1>" +
        chkforDate +
        " Call</h1><div class='container mt-5' style='overflow-x:scroll;'>" +
        the_table +
        "</tbody></div>";
      $("#table1").DataTable({ stateSave: true });
    },
...
function getAudioLink(condition) {
  if (condition != "") {
    return (
      "<a href='javascript:void(0)' onClick=openAudioNewTab('" +
      condition +
      "')>Open recording</a>"
    );
  } else {
...
function CheckCallWaiseStatus(startDate, endDate) {
  $.ajax({
    ...
    success: function (res) {
      ...
      document.getElementById("statsDisplay3").innerHTML =
        "<div class='container mt-5' style='overflow-x:scroll;'>" +
        the_table +
        "</tbody></div>";
      $("#table1").DataTable({ stateSave: true });
...
function LoadOrphanLeads() {
  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      document.getElementById("displayContent").innerHTML =
        "<h1> </h1><div class='container mt-5' style='overflow-x:scroll;'>" +
        the_table +
        "</tbody></div>";
      $("#table1").DataTable({ stateSave: true });
    },
...
function stopRecordMulti(lead_id, index, tableId) {
  ...
  const recordingInfo = recordings.find(
    (recording) => recording.callDetails.leadId === lead_id
  );
  ...
  document.getElementById("save-id-" + tableId + "-" + index).style.display =
    "none";
}
...
function uploadSave() {
  ...
  if (recordingInfo) {
    uploadPhoto(
      cordova.file.externalRootDirectory + recordingInfo.filename,
      recordingInfo.callDetails,
      function (success) {
        if (success) {
...
async function get_all_shop_order_count() {
  let req = await fetch(
    "https://master.mygalla.com/master_api/index.php?type=061&total=shopdata",
    {
      method: "POST",
      redirect: "follow",
    }
...
async function get_single_shop_data(mobile_no) {
  ...
  let req = await fetch(
    `https://master.mygalla.com/master_api/index.php?type=064&mobile=${mobile_no}`,
    {
      method: "POST",
      redirect: "follow",
    }
...
function testallLeadsTL() {
  ...
  content += "</tbody></table></div>";
  document.getElementById("displayContent").innerHTML =
    "<h1>All Leads</h1><div><a href='https://teamka.in/crm1/APIs/leads_export.php'>Export</a></div><div style='overflow-x:scroll;'>" +
    content;
  var me = localStorage.getItem("userID");
  var table = $("#table1").DataTable({
    order: [[0, "desc"]],
      ...
      },
      {
        ...
        render: function (data, type, part, meta) {
          ...
          if (type === "display") {
            ...
            data =
              '<k id="showdataTLLeads' +
              part[0] +
              '"><button onclick=showdataTLLeads("' +
              part[0] +
              '","' +
              encoded +
              '")>Show Data</button></k>';
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      for (let i = 0; i < projects.length - 1; i++) {
        ...
        content +=
          "<option value=" + parseInt(data[0]) + " >" + data[1] + "</option>";
      }
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (
        ...
        localStorage.getItem("userType") == "TL"
      ) {
...
function fillUpdateForm(id) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      document.getElementById("edit_district").innerHTML =
        "<option value='" + data[11] + "'>" + data[11] + "</option>";
...
function updateLeads() {
  ...
  if (name == "" || mobile == "") {
    document.getElementById("editErrorDetails").innerHTML =
      "Fill the Form Correctly";
  } else {
    $(".loader").show();
...
function handleDemoCallScenario(callStatus, id, callerID) {
  ...
  switch (callStatus) {
    ...
    default:
      console.log(
        "Unknown Scenario: No action available for this scenario.",
        callStatus
      );
      break;
  }
...
function getAudio(condition) {
  if (condition != "") {
    return (
      ...
      condition +
      "' type='audio/mpeg'>Your browser does not support the html audio tag.</audio>"
    );
  } else {
    return "";
  }
    ...
    columns: [
      ...
      { data: "Next_Call_Date" },
      {
        ...
        render: function (data, type, row) {
          ...
          return (
            '<button class="load-audio-btn" data-audio-url="' +
            data +
            '" data-duration="' +
            duration +
            '">Load Audio</button>'
    ...
    success: function (response) {
      ...
      if (response == 1) {
        document.getElementById("mailOption").innerHTML =
          "<button class='btn btn-success' onclick='sendMail(" +
          id +
          ")'>Send Mail</button><p id='errorMail' style='text-align: right;color: crimson;'></p>";
      } else {
        document.getElementById("mailOption").innerHTML = "";
      }
    },
...
function allLeadsOnDate(date) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      content += "</tbody></table></div>";
      document.getElementById("displayContent").innerHTML =
        "<h1>&#x2706; To be Contacted </h1><div style='overflow-x:scroll;'>" +
        content;
      $("#table1").DataTable({ order: [[0, "desc"]], stateSave: true });
    },
    error: function (jqXHR, exception) {
...
function dateChange() {
  ...
  if (fromdate != "") {
    ...
    if (todate != "") {
      ...
      var x = new Date(
        fromdateFormatArray[2] +
          "-" +
          fromdateFormatArray[1] +
          "-" +
          fromdateFormatArray[0]
      );
      var y = new Date(
        todateFormatArray[2] +
          "-" +
...
function setDetails() {
  ...
  $.ajax({
    ...
    success: function (response) {
      $(".loader").hide();
      var data = response.split("<-->");
      document.getElementById("callerA").innerHTML =
        "<option value='" +
        parseInt(data[3]) +
        "' selected>" +
        data[0] +
        "</option>";
      document.getElementById("edit_callerA").innerHTML =
        "<option value='" +
        parseInt(data[3]) +
        "' selected>" +
        data[0] +
...
function addProjectDetails() {
  ...
  if (
    ...
    document.getElementById("errorDetailsAddProject").innerHTML =
      "Fill the Form Correctly";
  } else {
    $(".loader").show();
    $.ajax({
      ...
      success: function (response) {
        ...
        if (response == 1) {
          ...
          document.getElementById("errorDetailsAddProject").innerHTML =
            "Project Details Already Filled";
        } else {
          alert(response);
        }
      },
...
function getProjectDetailsSupportNew() {
  ...
  document.getElementById(
    "displayContent"
  ).innerHTML = `<h1>Project Details</h1> <div class="d-flex column-gap-3 justify-content-center" > <select id="projectTypeFilter">
...
function getProjectDetails() {
  ...
  content += "</tbody></table></div>";
  document.getElementById("displayContent").innerHTML =
    "<h1>Project Details</h1><div style='overflow-x:scroll;'>" + content;
...
function fullDetails(id) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      document.getElementById("fullProjectDetails").innerHTML =
        "<div style='overflow-x:scroll;'>" + content + "</tbody></table>";
    },
    error: function (jqXHR, exception) {
      var msg = displayerror(jqXHR, exception);
      alert(msg);
...
function addNewProjectStatus() {
  ...
  if (summary == "" || remark == "") {
    document.getElementById("errorProjectDetailsStatus").innerHTML =
      "Fill the Form Correctly";
  } else {
    $(".loader").show();
    $.ajax({
...
function getProjectStatus(id) {
  var content =
    '<table id="tableProjectStatus" class="table table-bordered table-striped"><thead><th>Summary</th><th>Remarks</th><th>Updated By</th><th>DOR</th></thead><tbody>';
  $(".loader").show();
  $.ajax({
    url: Config.api_url,
...
function updateProjectDetails() {
  ...
  if (
    ...
    document.getElementById("editErrorProjectDetails").innerHTML =
      "Fill Form Correctly";
  } else {
    $(".loader").show();
    $.ajax({
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      for (let index = 1; index <= totalUpdates; index++) {
        ...
        var part = element.split("<-->");
        if (
          localStorage.getItem("userID") == parseInt(part[3]) ||
          localStorage.getItem("userID") == parseInt(part[12])
        ) {
      ...
      document.getElementById("displayContent").innerHTML =
        "<h1>Project Details</h1><div style='overflow-x:scroll;'>" +
        content +
        "</tbody></table>";
...
function getProjectDetailsTL() {
  ...
  content += "</tbody></table></div>";
  document.getElementById("displayContent").innerHTML =
    "<h1>Team Project Details</h1><div style='overflow-x:scroll;'>" + content;
  let callerID = localStorage.getItem("userID");
  var table = $("#tableProjects").DataTable({
    order: [[0, "desc"]],
    processing: false,
...
function addProjectDiscount() {
  ...
  if (discount == "") {
    document.getElementById("errorProjectDiscount").innerHTML =
      "Enter Amount to Add";
  } else {
    $(".loader").show();
    $.ajax({
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (email == "") {
        ...
        content =
          content +
          "<tr><th style=' border: 1px solid black;padding:4px;border-spacing: 0px;' colspan='4'><center><h3>Thanks For Your Bill</h3></center></th></tr>";
        content =
          content +
          "</tbody></table><br><br>Feel free to reach us out for any help.<br><br>Regards<br>" +
          caller +
          "<br>" +
          contact +
          "<br><b>Kalam Academy</b>";
...
function getAllProjectPaymentTL(id) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      var content =
        "<table class='table table-striped table-bordered'><thead><th>ID</th><th>Amount</th><th>Proof</th><th>DOR</th><th>Remarks</th></thead><tbody>";
      for (let i = 0; i < len; i++) {
        ...
        if (parseInt(data[4]) == 1) {
          ...
          if (localStorage.getItem("userType") == "Admin")
            var status =
              "Unverified<br><button onclick='verifyPayment(" +
              parseInt(data[5]) +
              "," +
              id +
              ")'>VERIFY</button>";
      ...
      document.getElementById("allProjectPayment").innerHTML =
        content +
        "</tbody></table><div class='container'><b>Total : Rs </b>" +
        amount +
        "</div>";
...
function getUnverifiedPayment() {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      document.getElementById("displayContent").innerHTML =
        "<h1>Payments</h1><div class='container' style='overflow-x:scroll;'>" +
        content +
        "</tbody></table></div>";
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        document
          ...
          .insertAdjacentHTML(
            "beforeend",
            "<h1 class='mt-5'>Lead Search Results</h1><div style='overflow-x:scroll;'>" +
              content
          );
        $("#table1").DataTable({ order: [[0, "desc"]], stateSave: true });
      },
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        document
          ...
          .insertAdjacentHTML(
            "beforeend",
            "<h1 class='mt-5'>Project Details</h1><div style='overflow-x:scroll;'>" +
              content1 +
              "</tbody></table>"
          );
        $("#tableProjects").DataTable({
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      for (let index = 1; index <= totalUpdates; index++) {
        ...
        if (
          (parseInt(year) == yearReal + 1 && monthReal <= parseInt(month)) ||
          yearReal + 1 < parseInt(year)
        ) {
          if (part[14] == "No dues") {
            content +=
              "<tr><td>" +
      ...
      document.getElementById("displayContent").innerHTML =
        "<h1>Renewal Required</h1><div style='overflow-x:scroll;'>" +
        content +
        "</tbody></table><div class='container mt-5' id='renewedList'></div>";
...
function renewedList() {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      document.getElementById("renewedList").innerHTML =
        "<h1>Renewal Added</h1><div style='overflow-x:scroll;'>" +
        content +
        "</tbody></table></div>";
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (response == "dateError") {
        ...
        document.getElementById("errorDetailsStats").innerHTML = "";
        document.getElementById("statsDisplay1").innerHTML =
          content + "</tbody></table>";
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (response == "dateError") {
        ...
        document.getElementById("errorDetailsStats").innerHTML = "";
        document.getElementById("statsDisplay2").innerHTML =
          content + "</tbody></table>";
...
function allLeadsSupport() {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      content += "</tbody></table></div>";
      document.getElementById("displayContent").innerHTML =
        "<h1>All Leads</h1><div style='overflow-x:scroll;'>" + content;
      $("#table1").DataTable({ order: [[0, "desc"]], stateSave: true });
    },
    error: function (jqXHR, exception) {
      var msg = displayerror(jqXHR, exception);
...
function getAllStatusSupport(id) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      var content =
        "<table class='table table-bordered table-striped'><thead><th>Called By</th><th>On</th><th>Summary</th><th>Next Call</th></thead><tbody>";
      ...
      if (localStorage.getItem("userType") == "Admin") {
        document.getElementById("allStatus").innerHTML =
          content +
          "</tbody></table><div class='container' id='mailOption'></div>";
      } else if (localStorage.getItem("userType") == "Caller") {
        document.getElementById("allStatus").innerHTML =
          content +
          "</tbody></table><div class='container' id='mailOption'></div>";
        document.getElementById("allStatusCallers").innerHTML =
          content + "</tbody></table>";
      } else if (localStorage.getItem("userType") == "Developer") {
        document.getElementById("allStatus").innerHTML =
          content +
...
function getAllProjectStatusSupport(id) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      if (localStorage.getItem("userType") == "Admin") {
        document.getElementById("allMyStatus").innerHTML =
          content +
          "</tbody></table><div class='container' id='mailOption'></div>";
      } else if (localStorage.getItem("userType") == "Caller") {
        document.getElementById("allMyStatus").innerHTML =
    ...
    success: function (response) {
      ...
      for (let index = 1; index <= totalUpdates; index++) {
        ...
        if (part[9] != "") {
          ...
          special =
            " <button onclick='markCompletion2(" +
            part[13] +
            "); setTaskIdOnFeedback(" +
            part[13] +
      ...
      document.getElementById("viewProjectTaskForSupport").innerHTML =
        "<h1>Project Task Assigned</h1><div style='overflow-x:scroll;'>" +
        content +
        "</tbody></table>";
...
function getAllProjectPaymentSupport(id) {
  ...
  $.ajax({
    ...
    success: function (response) {
      ...
      var amount = partial[len];
      var content =
        "<table class='table table-striped table-bordered'><thead><th>Amount</th><th>Proof</th><th>DOR</th><th>Remarks</th><th>Status</th></thead><tbody>";
      for (let i = 0; i < len; i++) {
        var data = partial[i].split("<-->");
        if (parseInt(data[4]) == 1) {
          var status = "Verified";
...
function getProjectBillingSupport(id) {
  ...
  document.getElementById("projectIDBilling").value = id;
  var content =
    '<table id="tableProjects" class="table table-bordered table-striped"><thead><th>Addon Name</th><!--<th>Addon Price</th>--><th>DOR:</th></thead><tbody>';
  $(".loader").show();
  $.ajax({
    url: Config.api_url,
    data: { operation: "031", id: id },
...
function assignProjectTask() {
  ...
  if (
    ...
    document.getElementById("errorDetailsAssignTask").innerHTML =
      "Fill the Form Correctly";
  } else {
    $.ajax({
      url: Config.api_url,
      ...
      success: function (response) {
        if (response == 0) {
          ...
          var con = confirm(
            "Task :" +
              response.trimEnd() +
              " already added to this project. Continue ?"
          );
          if (con) {
            addTask();
          } else {
...
function assignedByMe() {
  var content =
    '<table id="tableProjects" class="table table-bordered table-striped"><thead><th>TaskID</th><th>Project :</th><th>Assigned By :</th><th>Assigned To<Br>Completed By :</th><th>Work :</th><th>Remark :</th><th>Assigned On :</th><th>Priority :</th><th>Deadline :</th><th>Completion Date :</th><th>Status :</th><th>Rating :</th></thead><tbody>';
  document.getElementById("displayContent").innerHTML =
    "<h1>Tasks Assigned by me</h1><button class='btn btn-link' onclick='assignedByMe()'>Assigned By Me</button><div style='overflow-x:scroll;'>" +
    content +
    "</tbody></table>";
  var id = localStorage.getItem("userID");
  var table = $("#tableProjects").DataTable({
...
function assignedToMe() {
  var content =
    '<table id="tableProjects" class="table table-bordered table-striped"><thead><th>TaskID</th><th>Project :</th><th>Assigned By :</th><th>Assigned To<Br>Completed By :</th><th>Work :</th><th>Remark :</th><th>Assigned On :</th><th>Priority :</th><th>Deadline :</th><th>Completion Date :</th><th>Status :</th><th>Rating :</th></thead><tbody>';
  document.getElementById("displayContent").innerHTML =
    "<h1>My Tasks</h1><div style='overflow-x:scroll;'>" +
    content +
    "</tbody></table>";
  var id = localStorage.getItem("userID");
  var table = $("#tableProjects").DataTable({
...
function markfakeCompletion(id, status) {
  var cnf = confirm(
    "Confirm Mark " + (status === "Fake" ? "Fake" : "Incomplete") + "?"
  );
...
function loadcallerdemoleads() {
  ...
  $.ajax({
    ...
    success: function (responseOut) {
      ...
      var leadToDemoRatioToday =
        leads_today > 0 ? demo_leads_today / leads_today : 0; // Prevent division by zero
      ...
      var leadToDemoRatioTodayPercentage =
        (leadToDemoRatioToday * 100).toFixed(2) + "%";
      var leadToDemoRatioTotalPercentage =
        (leadToDemoRatioTotal * 100).toFixed(2) + "%";
...
function sendPing() {
  ...
  if (phoneNumber) {
    ...
    const formattedTime = `${customTime.getFullYear()}-${pad(
      customTime.getMonth() + 1
    )}-${pad(customTime.getDate())} ${pad(customTime.getHours())}:${pad(
...
["log", "warn", "error"].forEach(function (method) {
  ...
  console[method] = function (...args) {
    ...
    logMessages.push(
      `[${method.toUpperCase()}] ${new Date().toISOString()}: ${args.join(" ")}`
    );
            ...
            function (fileEntry) {
              ...
              fileEntry.createWriter(function (fileWriter) {
                ...
                fileWriter.onerror = function (e) {
                  console.error(
                    "Failed to append to log file: " + e.toString()
                  );
                };
